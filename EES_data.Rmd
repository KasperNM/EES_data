...
subset_2009 = select(df_2009, "t201c", "q1", "t100", "q4", "q2", "q3", "t102")
...
write_excel_csv(subset_2009,"/Users/kaspermichelsen/EES_data/2009_subset.xlsx")
...
subset_2014 <- select(df_2014, "countrycode", "respid", "qpp1aO_EES", "qpp1bO_EES")
...
write_excel_csv(subset_2014,"/Users/kaspermichelsen/EES_data/2014_subset.xlsx")
...
write_excel_csv(subset_1999,"/Users/kaspermichelsen/EES_data/1999_subset.xlsx")
...
#df_2004 = read_sav("ZA4566.sav")
subset_2004 <- select(df_2004, "country", "idnum", "v285", "v015", "v016", "v017", "v018", "v019", "v020", "v021", "v022", "v023", "v024", "v025", "v026", "v027", "v028", "v029")
...
write_excel_csv(subset_2004,"/Users/kaspermichelsen/EES_data/2004_subset.xlsx")
...
write_excel_csv(subset_2019_new1,"/Users/kaspermichelsen/EES_data/2019_subset.xlsx")
...
parlgovtest <- select(Parlgov, "ees", "party_name_short", "party_name", "family_name", "left_right", "state_market", "liberty_authority", "eu_anti_pro")
parlgovtest1 <- select(Parlgov, "ees")
...
mp2009 <- merge.data.frame(merge2009parlgov, pt, by="ees")

write_excel_csv(mp2009,"/Users/kaspermichelsen/EES_data/2009_parlgov_merge.xlsx")
```
