...
mp2009NVA <- merge.data.frame(mp2009_new, NVA2009, by="q27")
mp2009VI <- merge.data.frame(mp2009NVA, VI2009, by="q28")
mpfinal <- merge.data.frame(mp2009VI, PID2009, by="q87")

uniq1 <- unique(mp2009VI)
...
write_excel_csv(mpfinal,"/Users/kaspermichelsen/EES_data/final2009.xlsx")
```
